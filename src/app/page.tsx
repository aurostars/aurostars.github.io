          ...
          {[
            {
              ...
              highlights: [
                ...
                `运营与用户研究：深入医院组织医生培训，推动医院自主化常态运营；开展用户调研，构建医生用户画像，明确“做稳简单场景→统一表达模板→拓展复杂病例”的三阶段迭代目标。试用2个月覆盖30+诊室、70+医生，月产出4000+份报告。`,
                "AI提效：识别到人工逐份分析运营数据的效率瓶颈，设计了LLM自动分析+人工复核的协同工作流，单份分析耗时缩短50%+；面向后台管理系统场景，设计了PRD生成高保真原型的Skill，通过构建50+高频场景的模块化组块库并引入壳文件，确保产出稳定性，需求转原型效率提升80%+。",
              ],
            },
            {
              ...
              highlights: [
                ...
                "业务需求产品化：识别质检系统的痛点并优化，例如基于一线手动创建质检任务的业务痛点，提炼任务自动生成的需求，推动功能迭代上线，每人每次质检节省30s。",
              ],
            },
            {
              ...
              highlights: [
                ...
                "智能总结功能：针对准确快速阅读内参报告的需求，基于报告特性搭建应急/经济/民生等场景化模板库，设计prompt策略，通过专家评估+用户反馈完成多轮调优，支撑智能总结功能上线。",
              ],
            },
            {
              ...
              highlights: [
                ...
                "数据驱动迭代：搭建20+职位的点击率、匹配率等指标监控看板，持续追踪优化策略上线效果，基于数据反馈推动方案调整与二次迭代。",
              ],
            },
            {
              ...
              highlights: [
                ...
                "数据分析与可视化：运用Thinkcell、Excel等工具，对数据进行分析与可视化，有效呈现核心观点。",
                "日常动态追踪：独立撰写8篇行业周报，持续跟踪市场动态。",
              ],
            },
          ].map((item, i) => (
